  ...
  Widget _buildContent(BuildContext context, AppUser user) {
    ...
    switch (user.role) {
      case 'admin':
        ...
        pages = [
          HalamanRingkasanAdmin(repository: _repository, user: user, userRepository: _userRepository),
      ...
      case 'pengelola':
        ...
        pages = [
          HalamanRingkasanPengelola(repository: _repository, user: user),
          HalamanPetaKegiatan(repository: _repository),
          HalamanArsipLaporan(repository: _repository),
        ];
        break;
      ...
      case 'penelaah':
        ...
        pages = [
          HalamanRingkasanPenelaah(repository: _repository, user: user),
          HalamanArsipLaporan(repository: _repository),
          HalamanStatistikKebijakan(repository: _repository),
        ];
        break;
      ...
      default:
        ...
        titles = ['Dashboard', 'Kegiatanku', 'Arsip'];
        icons = [Icons.dashboard_rounded, Icons.event_note_rounded, Icons.inventory_2_rounded];
        pages = [
          HalamanRingkasanPenyuluh(repository: _repository, user: user),
          HalamanKegiatan(repository: _repository),
          HalamanArsipPenyuluh(repository: _repository),
        ];
        break;
    }
